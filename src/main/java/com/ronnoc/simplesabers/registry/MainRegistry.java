...
public class MainRegistry {
    ...
    //Lightsaber Crystals
    public static final RegistryObject<Item> KYBER_CRYSTAL_RED = ITEMS.register("kyber_crystal_red", () -> new Item(new Item.Properties()
            .group(SimpleSabers.TAB).isImmuneToFire().maxStackSize(1).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> KYBER_CRYSTAL_BLUE = ITEMS.register("kyber_crystal_blue", () -> new Item(new Item.Properties()
            .group(SimpleSabers.TAB).isImmuneToFire().maxStackSize(1).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> KYBER_CRYSTAL_GREEN = ITEMS.register("kyber_crystal_green", () -> new Item(new Item.Properties()
            .group(SimpleSabers.TAB).isImmuneToFire().maxStackSize(1).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> KYBER_CRYSTAL_PURPLE = ITEMS.register("kyber_crystal_purple", () -> new Item(new Item.Properties()
            .group(SimpleSabers.TAB).isImmuneToFire().maxStackSize(1).rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<SwordItem> RED_LIGHTSABER = ITEMS.register("red_lightsaber", () ->
            new SwordItem(LightsaberMaterial.INSTANCE, 0, 0.0F, new Item.Properties().group(SimpleSabers.TAB).setNoRepair().maxStackSize(1)));
    public static final RegistryObject<SwordItem> BLUE_LIGHTSABER = ITEMS.register("blue_lightsaber", () ->
            new SwordItem(LightsaberMaterial.INSTANCE, 0, 0.0F, new Item.Properties().group(SimpleSabers.TAB).setNoRepair().maxStackSize(1)));
    public static final RegistryObject<SwordItem> GREEN_LIGHTSABER = ITEMS.register("green_lightsaber", () ->
            new SwordItem(LightsaberMaterial.INSTANCE, 0, 0.0F, new Item.Properties().group(SimpleSabers.TAB).setNoRepair().maxStackSize(1)));
    ...
    public static final RegistryObject<SwordItem> YELLOW_LIGHTSABER = ITEMS.register("yellow_lightsaber", () ->
            new SwordItem(LightsaberMaterial.INSTANCE, 0, 0.0F, new Item.Properties().group(SimpleSabers.TAB).setNoRepair().maxStackSize(1)));
    public static final RegistryObject<SwordItem> WHITE_LIGHTSABER = ITEMS.register("white_lightsaber", () ->
            new SwordItem(LightsaberMaterial.INSTANCE, 0, 0.0F, new Item.Properties().group(SimpleSabers.TAB).setNoRepair().maxStackSize(1)));
